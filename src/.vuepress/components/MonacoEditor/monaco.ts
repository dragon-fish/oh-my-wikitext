...
export const languages = shallowRef(monaco.languages.getLanguages()[0])

export function createModel(value = '', language?: string, uri?: monaco.Uri) {
  ...
  model.onDidChangeLanguage((e) => {
    languages.value = monaco.languages
      .getLanguages()
